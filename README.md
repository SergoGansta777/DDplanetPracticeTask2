...
- [DDplanetPracticeTask2](#ddplanetpracticetask2)
  - [Задание](#задание)
  - [База данных](#база-данных)
    - [Диaграмма базы данных](#диaграмма-базы-данных)
    - [Скрипт для создания БД](#скрипт-для-создания-бд)
    - [Подключение программы к БД](#подключение-программы-к-бд)
...
- Добавление адресов в локации с условием - у одной укправляющей компании локации не должны пересекаться. Например, невозможна ситуация, когда компания имеет локации:
   ...
   1. г. Тула, ул. Советская. В границах одна запись с заполненной улицей, городом, регионом.
...
<img width="498" alt="CleanShot 2023-07-19 at 16 20 11@2x" src="https://github.com/SergoGansta777/DDplanetPracticeTask2/assets/98104790/fc07dee7-afd7-43d5-b491-a4149426942a">
...
<img width="1465" alt="CleanShot 2023-07-19 at 16 20 57@2x" src="https://github.com/SergoGansta777/DDplanetPracticeTask2/assets/98104790/3c2006cc-6269-45d8-ab96-0feba0f94cdb">
